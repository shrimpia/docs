...
- 本サービスは、管理人による個人的な利用を主目的とした上で、無償かつ無保証で開放しています。
  - **大手のウェブサービスと同等の厳格な運営体制やポリシーを持ち合わせていません。**
  - それを理解した上でご登録・ご利用ください。
...
- 管理人と良好な関係を維持できること。
  - 管理人との断交状態が6ヶ月以上継続している場合、この条件を満たさないものとみなすことがあります。
...
加えて、ローカルタイムライン上では[ローカルタイムラインルール](/guidelines/ltl)が適用されます。
公開範囲を「パブリック」に設定している、チャンネル上ではない全ての投稿がこれに該当します。
...
- 運営は、以下の基準を満たすアカウントを、しばらく本サービスを利用していないとみなし、削除することができます。
  - 最後にノートを作成してから、6ヶ月以上経過したアカウント
  - 登録から1週間が経過し、ノートを1件も作成していないアカウント
