...
NSFW (Not Safe For Work) とは、職場等の公的な場所における閲覧に適さないことを表します。

本サーバーにおいて、以下のようなコンテンツをNSFWと定義します。NSFWとされるメディアを投稿に含める場合、投稿フォーム、あるいはドライブ画面にて「センシティブとして設定」をオンとしてください。
